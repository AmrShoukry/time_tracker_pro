...
const Projects = () => {
    ...
    function getFinalString(fromGivenTime, toGivenTime)
    {
        ...
        let fromText = `${fromDate} ~ ${fromHours.toString().padStart(2, '0')}:${fromMinutes.toString().padStart(2, '0')} ${fromTimeArea}`
        let toText = `${toDate} ~ ${toHours.toString().padStart(2, '0')}:${toMinutes.toString().padStart(2, '0')} ${toTimeArea}`
