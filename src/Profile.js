        ...
        <div className='Profile'>
            <div className="container">
                ...
                <div className="information">
                    ...
                    <h4>Number of Active Projects: <span>{active}</span> </h4>
                    <h4>Number of Completed Projects: <span>{completetd}</span> </h4>
                    <h4>Number of Uncompleted Projects: <span>{uncompleted}</span> </h4>
